...
```ts
  ...
  107 |         }
  108 |         const mensagem = await page.locator('#msg').textContent({timeout: 500});
  109 |         console.log("A mensagem recebida: \n",  mensagem);
  110 |         await expect(page.locator('#msg')).toHaveText('Order placed successfully');
  111 |         await page.screenshot({path: "Evidencias/checkout/CheckoutProdutoBotaoCompleteOrder.png"});
  112 |           
  113 |     });
  114 |        
